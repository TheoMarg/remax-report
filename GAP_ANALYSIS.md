...
Features **1, 3, 5, 6, 7, 17** μπορουν να υλοποιηθουν **κυριως με τα υπαρχοντα data** (v_combined_metrics, closings, properties, v_property_events_timeline, ypodikseis, agents, teams, exclusives, status_changes, price_changes).
